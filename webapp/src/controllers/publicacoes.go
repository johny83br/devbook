...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s:%d/api/publicacoes", config.API_URL, config.API_PORTA)
...
func CurtirPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s:%d/api/publicacoes/%d/curtir", config.API_URL, config.API_PORTA, publicacaoId)
...
func DescurtirPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s:%d/api/publicacoes/%d/descurtir", config.API_URL, config.API_PORTA, publicacaoId)
	response, erro := requisicoes.FazerRequisicaoComAutenticacao(r, http.MethodPost, url, nil)
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s:%d/api/publicacoes/%d", config.API_URL, config.API_PORTA, publicacaoId)
